...
def create_matrices(search_h, search_w, pattern_h, pattern_w):
    search = [[randint(0, 10) for _ in range(search_w)] for _ in range(search_h)]
    pattern = [[randint(0, 10) for _ in range(pattern_w)] for _ in range(pattern_h)]
    for _ in range(0, 5):
